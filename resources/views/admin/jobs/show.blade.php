                            ...
                            <div data-repeater-list="parts" class="ml-2">
                                ...
                                @if(is_array($parts) && count($parts) >0)
                                    @foreach($parts as $part)
                                            <div data-repeater-item class="mt-2 row">
                                                ...
                                                <input type="number" step="0.01" min="0" placeholder="Total Price?" value="{{@$part->price}}" class="form-control required col-2 mr-1" id="price" name="price" required>
                                ...
                                @else
                                        <div data-repeater-item class="mt-2 row">
                                            ...
                                            <input type="number" step="0.01" min="0" placeholder="Total Price?" class="form-control required col-2 mr-1" id="price" name="price" required>
                                            <i data-repeater-delete class="fa fa-trash text-danger" style="font-size: 35px;cursor: pointer"></i>
                                        </div>
